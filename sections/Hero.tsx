  ...
  return (
    <div className="mx-5 relative h-[100dvh] flex flex-col justify-center" ref={containerRef}>
      ...
      <button
        ...
        className="fixed bottom-4 right-4 z-[70] size-10 rounded-full bg-black/70 text-white/80 text-lg backdrop-blur-md flex items-center justify-center hover:bg-black/90 transition-colors"
      >
        {showControls ? "✕" : "⚙"}
      </button>
      {showControls && (
        <div className="fixed bottom-16 right-4 z-[60] flex flex-col gap-3 rounded-2xl bg-black/70 p-4 text-white text-xs backdrop-blur-md w-56 max-h-[60vh] overflow-y-auto">
          <Slider
            label="Blur"
            min={0}
            max={20}
